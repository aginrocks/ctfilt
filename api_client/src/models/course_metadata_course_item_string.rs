...
/// CourseMetadataCourseItemString : Metadata for a course  # Generics:  - `Item`: The type used to store individual course item
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CourseMetadataCourseItemString {
...
impl CourseMetadataCourseItemString {
    /// Metadata for a course  # Generics:  - `Item`: The type used to store individual course item
    pub fn new(description: String, difficulty: models::CourseDifficulty, items: Vec<models::CourseMetadataCourseItemStringItemsInner>, name: String, slug: String) -> CourseMetadataCourseItemString {
